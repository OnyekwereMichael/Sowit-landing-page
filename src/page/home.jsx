...
function Home() {
  ...
  return (
    <div>
     {contact ? <Nav closeModal = {setContact}/> : <Nav />}
      {/* Main Content */}
      <main>
        {/* Hero Section */}
        <section className=''>
      <div className='px-3 smi:px-1 smm:px-2 xsmm:px-2 xmm:px-2'>
       <div className='gradient pt-6 pb-4 bg-gradient-to-t from-[#FFFFFF] to-[#F5F6F8] rounded-[50px] smm:rounded-[35px] smi:rounded-[25px] xmm:rounded-[35px] xsmm:rounded-[35px] smm:py-3 xsmm:py-3 xmm:py-3 lgg:py-1' id='top'>
          <div className='text-center mt-10 smm:px-2 lgg:px-2 smm:mt-2' >
            <h1 className='text-3xl  smm:text-[24px] smi:text-[18px] lgg:text-[26px] xsmm:text-[22px] font-Urbanist font-extrabold mt-14 smi:mt-0 xmm:mt-1 xsmm:mt-0 smm:mt-0 lgg:mt-3'>
            ...
            <div className='flex items-center justify-center my-5 mt-5 smm:px-5 xsmm:px-2 xmm:px-1 smi:px-1'>
              <div className="bg-white p-[5px] w-[400px] rounded-full flex items-center justify-between border-[#227EFD] border-[2px] mx-auto smm:p-[5px] smi:p-[4px] smi:[430px]">
          ...
          <div className="flex justify-center gap-3 mt-3  px-12 smm:flex-wrap smm:px-5 smm:mt-0 ">
            <div className='lin px-6 pt-6 rounded-3xl  smm:my-3'>
              ...
              <div className='mt-4'>
                    <img src={images.insightDemo} alt="" />  
              </div>
            </div>
                    ...
                    <section className='flex items-center justify-center mx-auto '>
                            <div className='mx-auto '>
                                ...
                                <div className=' flex justify-center items-center'>
                                    <img src={images.video} alt="Sowwit video" className='xll:w-screen' />
                                </div>
                                </div>
                            </div>
                </section>
   ...
   {/* benefit of sowwit  */}
        <section className='bg-[#F7FBFF] mt-8 smm:py-[0px]'>
            <div className='px-8 smm:p-[1px] py-5 lgg:px-4 xll:px-4'>
                <div className='flex items-center gap-2 bg-[#E9F2FF] text-[#227EFD]  w-[10%] py-2 px-6 rounded-full smm:w-[27%] mt-5 smm:px-0 smm:justify-center xmm:w-[30%] smi:w-[35%] lgg:w-[16%] xll:w-[13%] mx-4'>
          ...
          <div className='grid grid-cols-4 p-8 rounded-lg   smm:hidden lgg:hidden xll:hidden'>
                {benefit.map((item, i) => {
                    return (
                        <div key={i} className=' lgg:my-8  p-4 ml-4 border-l border-b border-gray-100'>
...
{/* FAQ Section  */}
  ...
  {/* contact section      */}
     ...
     {/* joining waitlist  */}
        <section className='flex items-center justify-around  bg-[#1666D4] py-[2px] pb-0 smm:px-4 smm:py-[1px] smm:flex-wrap  xll:px-4' id='signup'>
          <div>
 ...
 {/* wait list form  */}
      ...
      {contact ? <Footer closeModal = {setContact}/> : <Footer />}
